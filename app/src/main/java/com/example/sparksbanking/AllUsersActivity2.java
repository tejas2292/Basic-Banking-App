...
public class AllUsersActivity2 extends AppCompatActivity {
    ...
    private void enterAmount() {
        ...
        dialog.getButton(AlertDialog.BUTTON_POSITIVE).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                else if(Integer.parseInt(mAmount.getText().toString()) + 0 == 0){
                    mAmount.setError("You can't send 0 Rs");
                }else {
                    Intent intent = new Intent(AllUsersActivity2.this, AllUsersActivity3.class);
    ...
    private void transactionCancel() {
        AlertDialog.Builder builder_exitbutton = new AlertDialog.Builder(AllUsersActivity2.this);
        builder_exitbutton.setTitle("Do you want to cancel the transaction?").setCancelable(false)
                .setPositiveButton("yes", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialogInterface, int i) {
                        Toast.makeText(AllUsersActivity2.this, "Transaction Cancelled!", Toast.LENGTH_LONG).show();
                    }
    ...
    public void onBackPressed() {
        startActivity(new Intent(AllUsersActivity2.this, AllUsersActivity1.class));
        finish();
    }
